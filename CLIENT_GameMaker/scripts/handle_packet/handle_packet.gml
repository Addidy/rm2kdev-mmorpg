...
switch(command){
	...
	case "LOGIN":
		...
		if(status == "TRUE"){
			...
			//with(instance_create_layer(target_x, target_y, 100, obj_Player)){
				//name = other.name;
			//}
		}else{
